...
function setEasyPieData()
{
	var total1 = getRandom(95,80);
	// var total2 = getRandom(85,70);
	// var total3 = getRandom(45,30);
	// var total4 = getRandom(55,10);
	// var total5 = getRandom(15,5);
	// var total6 = getRandom(100,80);
	
	charts[0].update(total1);
	// charts[1].update(total2);
	// charts[2].update(total3);
	// charts[3].update(total4);
	// charts[4].update(total5);
	// charts[5].update(total6);
	//$('#total1').html(total1+'%');
	// $('#total2').html(total2+'%');
	// $('#total3').html('+'+total3+'%');
	// $('#total4').html(total4+'%');
	...
	setTimeout(setEasyPieData, 3000);
}
