 ...
 * If 慣=0, then both control points will be the same as p1 (i.e. no smoothing).
 *
 ...
 * 1. Put the control points l1 and r1 慣 of the way down (p0, p1) and (p1, p2).
 * 2. Shift l1 and r2 so that the line l1�뱑1 passes through p1
 * 3. Adjust to prevent false extrema while keeping p1 on the l1�뱑1 line.
 *
...
function getControlPoints(p0, p1, p2, opt_alpha, opt_allowFalseExtrema) {
  ...
  // Step 2: shift the points up so that p1 is on the l1�뱑1 line.
  if (l1x != r1x) {
